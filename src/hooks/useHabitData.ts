...
const defaultHabits: Habit[] = [
  { id: '1', name: 'EXERCISE', type: 'goal', description: 'At least 30 minutes of physical activity', flameCount: 10 },
  { id: '2', name: 'MEDITATION', type: 'goal', description: 'Mindfulness practice or breathing exercises', flameCount: 8 },
  { id: '3', name: 'READING', type: 'goal', description: 'Read for personal growth or entertainment', flameCount: 6 },
  { id: '4', name: 'SOCIAL MEDIA', type: 'avoid', description: 'Limit mindless scrolling and consumption', flameCount: 12 },
  { id: '5', name: 'WATER INTAKE', type: 'critical', description: 'Stay properly hydrated throughout the day', flameCount: 15 }
];
